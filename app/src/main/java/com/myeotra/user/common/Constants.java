...
public interface Constants {
    ...
    interface LocationActions {
        ...
        String CHOOSADDARESSFROM = "chooseaddressfrom";
        String MULTIPLELOCATION = "multilocation";
        String SOURCELOCATION = "source_location";
        String DESTINATIONLOCATION = "desti_location";
    }

    /*interface FRAGMENTVISIBILITY {
        boolean DESTINATIONFRAGMENT = false;
        boolean SOURCEFRAGMENT = false;
    }*/
}
