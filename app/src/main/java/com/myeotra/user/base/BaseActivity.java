...
import com.myeotra.user.common.CustomDialog;
import com.myeotra.user.common.LocaleHelper;
import com.myeotra.user.data.SharedHelper;
import com.myeotra.user.ui.activity.OnBoardActivity;
import com.myeotra.user.ui.activity.login.EmailActivity;
import com.myeotra.user.ui.activity.login.PasswordActivity;
import com.myeotra.user.ui.activity.register.RegisterActivity;
import com.myeotra.user.ui.activity.social.SocialLoginActivity;
import com.myeotra.user.ui.activity.splash.SplashActivity;
...
//                            Toasty.error(this, getString(R.string.internal_server_error), Toast.LENGTH_SHORT).show();
    ...
    protected void initPayment(String mode, TextView paymentMode, ImageView paymentImage) {
        ...
        switch (mode) {
            case Constants.PaymentMode.CASH:
                ...
                paymentImage.setImageResource(R.drawable.ic_cash);
                break;
    ...
    protected Country getDeviceCountry(Activity context) {
