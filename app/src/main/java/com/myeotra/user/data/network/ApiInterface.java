package com.myeotra.user.data.network;
...
import com.myeotra.user.data.network.model.Coupon;
...
import com.myeotra.user.data.network.model.Rental;
...
public interface ApiInterface {
   ...
   /* @FormUrlEncoded
    ...
    @Multipart
    @POST("api/user/signup")
    Observable<RegisterResponse> register(@PartMap() Map<String, RequestBody> partMap, @Part MultipartBody.Part filename);
