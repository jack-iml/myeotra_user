...
public class InvoiceFragment extends BaseFragment implements InvoiceIView {
    ...
    private void initView(@NonNull Datum datum) {
        ...
        Log.e(TAG, "initView: " + new Gson().toJson(datum.getPayment()));
    ...
    public void onResume() {
        ...
        Log.e(TAG, "invoice onResume: " + new Gson().toJson(DATUM));

        Log.e(TAG, "invoice card: " + new Gson().toJson(datum));
    ...
    public void onSuccess(Object obj) {
        ...
        Log.e(TAG, "updateRide res : " + new Gson().toJson(obj));
    ...
    public void onSuccessPayment(Object o) {
        ...
        ((LocationPickedActivity) Objects.requireNonNull(getContext())).changeFlow("RATING");
    }
    ...
    public void onSuccess(Message message) {
        ...
        Log.e(TAG, "payment res : " + new Gson().toJson(message));
        ...
        Toasty.success(getContext(), R.string.you_have_successfully_paid, Toast.LENGTH_SHORT).show();
        ((LocationPickedActivity) Objects.requireNonNull(getContext())).changeFlow(RATING);
    }

    @Override
    public void onError(Throwable e) {
        Log.e(TAG, "invc frag error : " + e.getMessage());
...
//                            getKey(Objects.requireNonNull(getContext()), "currency"),
    ...
    public void onPayTmCheckSumSucess(PaytmObject payTmResponse) {
        ...
        Log.e(TAG, "onPayTmCheckSumSucess: " + new Gson().toJson(payTmResponse));
