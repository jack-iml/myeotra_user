...
import com.myeotra.user.ui.activity.change_password.ChangePasswordActivity;
...
public class ProfileActivity extends BaseActivity implements ProfileIView {
                ...
                AccountKit.getCurrentAccount(new AccountKitCallback<Account>() {
                    ...
                    public void onSuccess(Account account) {
                        ...
                        if (Objects.requireNonNull(AccountKit.getCurrentAccessToken()).getToken() != null) {
                            ...
                            mobile.setText("" + phoneNumber.getCountryCode() + " " + phoneNumber.getPhoneNumber());
    ...
    @OnClick({R.id.picture, R.id.save, R.id.change_password, R.id.qr_scan/*, R.id.mobile*/, R.id.menu})
    ...
    public void onSuccess(@NonNull User user) {
        ...
        Log.e(TAG, "getprofile Res: " + new Gson().toJson(user));
        try {
            hideLoading();
        } catch (Exception e1) {
            e1.printStackTrace();
