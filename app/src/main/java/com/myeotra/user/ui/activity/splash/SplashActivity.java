...
//        handleError(e);
    ...
    public void onSuccess(CheckVersion version) {
        ...
        Log.e(TAG, "response : CheckVersion -- " + new Gson().toJson(version));
    ...
    private void CallOnBoardActivity() {
...
//                    presenter.profile();
                    ...
                    nextScreen = new Intent(SplashActivity.this, OnBoardActivity.class);
                    nextScreen.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(nextScreen);
                }
    ...
    public void onSuccess(List<Service> services) {
        ...
        Log.e(TAG, "response : services -- " + new Gson().toJson(services));
        AsyncTask.execute(() -> {
            try {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        task.addOnSuccessListener(this, locationSettingsResponse -> runOnUiThread(this::CallOnBoardActivity));
